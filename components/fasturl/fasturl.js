// components/fasturl/fasturl.js

export const template = `
<div class="card fasturl-card" id="fastUrlCard">
  <div class="fasturl-row">
    <div class="fasturl-slot" id="fuSlot0"></div>
    <div class="fasturl-slot" id="fuSlot1"></div>
    <div class="fasturl-slot" id="fuSlot2"></div>
  </div>
</div>`;
